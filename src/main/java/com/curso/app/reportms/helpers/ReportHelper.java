package com.curso.app.reportms.helpers;
...
public class ReportHelper {
    ...
    public String readTemplate(Company company) {
        return this.reportTemplate.replace("{company}", company.getName())
    ...
    public List<String> getPlaceHoldersFromTemplate(String template) {
        ...
        return Arrays.stream(split).filter(line -> !line.isEmpty()).map(line -> {
